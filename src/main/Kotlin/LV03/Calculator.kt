...
class Calculator {
    ...
    fun run() {
        while(true) {
            first = checkInputValid("first").toString().toInt()
            second = checkInputValid("second").toString().toInt()
    ...
    fun Moduler(num1: Int, num2: Int): Any = println("나머지연산 결과: ${num1 % num2}")
}